                        ...
                        <div className="theme_search_form_area">
                            ...
                            <div className="theme_search_form_tabbtn">
                                <ul className="nav nav-tabs" role="tablist">
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link" id="recharge-tab" data-bs-toggle="tab" data-bs-target="#reacharge" type="button" role="tab" aria-controls="reacharge" aria-selected="false"><i
                                            className="fas fa-globe"></i>Recharge</button>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link" id="train-tab" data-bs-toggle="tab" data-bs-target="#train" type="button" role="tab" aria-controls="train" aria-selected="false"><i className="fas fa-ship"></i> Train</button>
                                    </li>
